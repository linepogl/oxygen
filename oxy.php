...
abstract class _oxy extends _oxy_dictionary {
	...
	public static function AbbrByteRate( $byterate ){ return '<span style="display:none;">'.sprintf('%030d',$byterate).'</span><abbr title="'. new XmlAttr(Language::FormatNumber($byterate).' '.Lemma::Pick('Unit_byte').'/'.Lemma::Pick('Unit_sec')).'" class="nowrap">'.Language::FormatBytes($byterate).'/'.Lemma::Pick('Unit_sec').'</abbr>'; }
	public static function AbbrByte( $bytes ){ return '<span style="display:none;">'.sprintf('%030d',$bytes).'</span><abbr title="'. new XmlAttr(Language::FormatNumber($bytes).' '.Lemma::Pick('Unit_byte')).'" class="nowrap">'.Language::FormatBytes($bytes).'</abbr>'; }
