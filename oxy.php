...
abstract class _oxy extends _oxy_dictionary {
	...
	public static function AbbrByteRate( $byterate ){ return '<span style="display:none;">'.sprintf('%030d',$byterate).'</span><abbr title="'. new XmlAttr(Language::FormatNumber($byterate).' '.oxy::txtUnit_byte().'/'.oxy::txtUnit_sec()).'" class="nowrap">'.Language::FormatBytes($byterate).'/'.oxy::txtUnit_sec().'</abbr>'; }
	public static function AbbrByte( $bytes ){ return '<span style="display:none;">'.sprintf('%030d',$bytes).'</span><abbr title="'. new XmlAttr(Language::FormatNumber($bytes).' '.oxy::txtUnit_byte()).'" class="nowrap">'.Language::FormatBytes($bytes).'</abbr>'; }
