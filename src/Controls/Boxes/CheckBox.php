...
class CheckBox extends Box {
	...
	private $list_names = [];
	public function WithListName($value){ $this->list_names[] = $value; return $this; }
	public function WithListNames(){ foreach (func_get_args() as $value) $this->list_names[] = $value; return $this; }
