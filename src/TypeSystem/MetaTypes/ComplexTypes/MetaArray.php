...
class MetaArray extends XConcreteType {
	...
	public static function ExportXmlString($value,$attr=false) {
		return implode(',',array_map(function($x)use($attr){ return XType::Of($x)->ExportXmlString($x,$attr); },$value));
	}
	...
	public static function ExportValString($value) {
		return implode(',',array_map(function($x){ return XType::Of($x)->ExportValString($x); },$value));
	}
